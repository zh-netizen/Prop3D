...
grid_x, grid_y, grid_smiles, sample_shape = read_griddata('/home/zhanghuan/atom3d/examples/esol/grid3Dmols_freesolv')
print(len(grid_x))
...
train_data,valid_data,test_data=shuffle_and_split_dict(all_dic,0.8,0.1,0.1,107)#42 77 55

...
def generate_split(excl_uncharacterized=True, excl_rdkitfails=True, out_dir_name='.', seed=42):
    ...
    test_indices, vali_indices, train_indices = splits.split_randomly(num_molecules, vali_split=0.1, test_split=0.1, random_seed=seed, exclude=exclude)
...
if __name__ == "__main__":
    ...
    generate_split( False,False,out_dir_name='../data/qm9/splits')
